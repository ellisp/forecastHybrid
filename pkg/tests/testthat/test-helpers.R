...
if (require(forecast) && require(testthat)) {
  ...
  test_that("Testing internal helper functions", {
    ...
    # Test getModel()
    expect_true(is.function(getModel("a")))
    expect_true(is.function(getModel("e")))
    expect_true(is.function(getModel("f")))
    expect_true(is.function(getModel("n")))
    expect_true(is.function(getModel("s")))
    expect_true(is.function(getModel("t")))
    expect_true(is.function(getModel("z")))
